 ...
 */
public class ShowCardsDialog extends DialogFragment{

    List<Card> cards;
    String requester;

    public static ShowCardsDialog newInstance(String cards, String requester) {
        ShowCardsDialog showCardsDialog = new ShowCardsDialog();

        Bundle args = new Bundle();
        args.putString("CARDS", cards);
        args.putString("REQUESTER", requester);
        showCardsDialog.setArguments(args);

        return showCardsDialog;
    }
        ...
        builder.setMessage("Do you accept ?")
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ((GameActivity)getActivity()).showResult(true, finalWinning);
                    }
                })
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ((GameActivity)getActivity()).showResult(false, finalWinning);
                    }
                })
                .setTitle("Show Cards");
